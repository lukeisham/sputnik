...
- [ ] 1. **Confirm ISS-023 — SputnikAlert unescaped string literals**
...
- [ ] 2. **Confirm ISS-024 — Orphaned ClaudeStatusLineReader / TerminalModelDetector**
...
- [ ] 3. **Confirm ISS-025 — MainAIMonitor deinit actor-isolation error**
...
- [ ] 4. **Confirm ISS-026 — Assorted API drift (five sub-issues)**
...
- [ ] 5. **Confirm ISS-027 — MainAIMonitor observe() data-race warning**
...
- [ ] 6. **Confirm ISS-028 — Window title not applied to NSWindow**
...
- [ ] 7. **Update Issues.md — add resolution notes for ISS-023 through ISS-028**
...
- [ ] Module Guide(s) updated (`status` + `last_updated`) — none required for this documentation-only plan
- [ ] Changes committed: `[2 Foundation] Close out ISS-023–028 compile-fix tracker entries`
- [ ] Pushed to GitHub
